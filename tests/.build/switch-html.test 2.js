/* switch-html.test.svelte.js generated by Svelte v5.56.8 */
...
// --- the prop must reach Select, not merely be accepted ----------------------
{
	...
	eq('Switch html=true matches Select html=true', b.querySelectorAll('button')[0].innerHTML.trim(), a.querySelectorAll('button')[0].innerHTML.trim());
}

// --- html must not disturb the boolean binding -------------------------------
{
	const seen = [];
	const st = $.proxy({ v: false });
	const target = document.createElement('div');
