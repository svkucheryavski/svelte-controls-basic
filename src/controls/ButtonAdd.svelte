<!--
@component Round button with add icon and main color.

   Main properties:
   - `title` - title (alternative text), default `'Add'`.
...
<script>
   ...
   let {title = 'Add', disable = false, onclick, class: className = ''} = $props();
</script>

<ButtonRound {title} {disable} {onclick} class={['button-add', className]}/>
