<!--
@component Round button with settings icon and main color.

   Main properties:
   - `title` - title (alternative text), default `'Settings'`.
...
<script>
   ...
   let {title = 'Settings', disable = false, onclick, class: className = ''} = $props();
</script>

<ButtonRound {title} {disable} {onclick} class={['button-settings', className]}/>
